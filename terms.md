...
_Last updated: 2026-05-08 (trial mechanic clarified)_
...
- The app will receive bug fixes for at least 12 months from your
  purchase date.
...
device, not a substitute for paying attention to the road.** Use at your
own risk. We're not liable for missed turns, lost data, drained batteries,
crashes, injuries, or any other consequence of using the app while
cycling.

If your jurisdiction requires consumer-protection minimums that exceed
"as-is, no warranty", those apply. Otherwise the app is provided as-is.

## Termination

You can stop using the app at any time — uninstall it. We can stop
distributing the app at any time. If we discontinue the app, your local
data and any past rides remain yours.

## Governing law

These terms are governed by the laws of Slovenia (EU). Any dispute will
be handled by the courts of Ljubljana, Slovenia.
