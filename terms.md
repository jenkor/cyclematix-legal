...
- **Conformity** (Directive 2019/770/EU Art. 8; Slovenian ZVPot-1).
  ...
  receive the updates needed to keep it in conformity for the period
  you can reasonably expect — at least the statutory minimum under
  your national law (two years in Slovenia and most EU member states).

- **Statutory remedies** (Directive 2019/770/EU Art. 14). If the app
  is not in conformity you are entitled, in order, to: have it brought
  into conformity at no cost; a proportionate price reduction; or
...
- The app will receive the updates required to maintain conformity
...
- Forward compatibility with new sensor protocols, map providers, or
  ride formats added by other companies.
...
You can stop using the app at any time — uninstall it. We may suspend
or terminate your access only for: (a) breach of these Terms,
(b) fraudulent or unlawful use, (c) a legal or security requirement,
or (d) discontinuation of the app. Where feasible we will give prior
notice and a chance to respond. If we discontinue the app, your local
data and any past rides remain yours and stay exportable from the app.

## Governing law and jurisdiction

These Terms are governed by Slovenian law. If you are a consumer in
the EU, the mandatory consumer-protection rules of your country of
residence continue to apply and are not displaced by this clause. Any
dispute may be brought before the courts of Ljubljana, Slovenia, or —
if you are a consumer — the courts of your place of residence
(Brussels I-bis, Reg. (EU) 1215/2012, Art. 18).
